...
#define dbg_m(mark, fmt, args ...)		\
	do {					\
		...
		if ((di_dbg & DBG_M_O_ALL) ||	\
		    (di_dbg & (mark))) {		\
			pr_info("dimini:" fmt, ##args); \
		}				\
	} while (0)

#define PR_ERR(fmt, args ...)		pr_err("dimini:err:" fmt, ##args)
#define PR_WARN(fmt, args ...)		pr_err("dimini:warn:" fmt, ##args)
#define PR_INF(fmt, args ...)		pr_info("dimini:" fmt, ##args)
