...
//ary tmp	unsigned int fmt_size_v     ; //13 bits
	...
	if (vf->di_pulldown == 1)//zapp_define
		skip_en = true;
...
struct afd_ops_s di_afd_ops_v3 = {
	...
	.is_supported_plink	= NULL,//afbc_is_supported_for_plink,
	.reg_sw_op		= NULL,//afbc_reg_sw_op,
	.inp_sw_op		= afbc_input_sw_op,
	.pvpp_reg_val		= NULL,//afbc_reg_variable_prelink,
	.pvpp_sw_setting_op	= NULL,//afbc_sw_op,
	.pvpp_pre_check_dvfm	= NULL,//afbc_pre_check_dvfm,
	.pvpp_en_pre_set	= NULL,//enable_afbc_input_dvfm,
};
